...
import Controller.ExameConvenioController;
 ...
 * @author lucas
 */
public class ExameConvenioTela extends javax.swing.JInternalFrame {

    ExameConvenioBeans exameB;
    ExameConvenioController exameC;
    DefaultTableModel modeloViamao;
    DefaultTableModel modeloPoa;
    
    public ExameConvenioTela() {
        initComponents();
        
        exameB = new ExameConvenioBeans();
        exameC = new ExameConvenioController();
    ...
    public void popularBeansParaViamao(){
        ...
        exameB.setCategoria(cbCategoriaViamao.getSelectedItem().toString());
    ...
    final void popularBeansParaPoa(){
        ...
        exameB.setCategoria(cbCategoriaPoa.getSelectedItem().toString());
    ...
    final void limparCamposViamao(){
        txtCodV.setText("");
        txtExameV.setText("");
        cbCategoriaViamao.setSelectedItem("Selecione...");
        txtValorV.setText("0");
    ...
    final void limparCamposPoa(){
        txtCodP.setText("");
        txtExameP.setText("");
        cbCategoriaPoa.setSelectedItem("Selecione...");
        txtValorP.setText("0");
    ...
    final void habilitarCamposViamao(boolean valor){
        ...
        cbCategoriaViamao.setEnabled(true);
    ...
    final void habilitarCamposPoa(boolean valor){
        ...
        cbCategoriaPoa.setEnabled(true);
    ...
    private void initComponents() {
        ...
        GuiaViamaoConvenio = new javax.swing.JPanel();
        ...
        cbCategoriaPoa = new javax.swing.JComboBox<>();
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Registro de Exames IPERGS - Patologistas Reunidos");
        ...
        cbCategoriaViamao.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione...", "1", "2", "3", "4", "5" }));
        cbCategoriaViamao.setEnabled(false);
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(cbCategoriaViamao, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                        .addGap(26, 26, 26)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(txtValorV, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addComponent(jLabel4)
                                .addGap(18, 18, 18)
                                .addComponent(txtObservacaoV, javax.swing.GroupLayout.PREFERRED_SIZE, 245, javax.swing.GroupLayout.PREFERRED_SIZE))
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(btnLimpaCamposViamao, javax.swing.GroupLayout.DEFAULT_SIZE, 119, Short.MAX_VALUE))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel11)
                    .addComponent(cbCategoriaViamao, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel3)
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(btnAdicionarViamao)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(btnNovoViamao, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        tblExamesViamao.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nº registro", "Exame", "Categoria", "Valor", "Observação"
            }
        ) {
        ...
        if (tblExamesViamao.getColumnModel().getColumnCount() > 0) {
            ...
            tblExamesViamao.getColumnModel().getColumn(1).setPreferredWidth(150);
            tblExamesViamao.getColumnModel().getColumn(2).setResizable(false);
            tblExamesViamao.getColumnModel().getColumn(2).setPreferredWidth(10);
            tblExamesViamao.getColumnModel().getColumn(3).setResizable(false);
            tblExamesViamao.getColumnModel().getColumn(3).setPreferredWidth(40);
            tblExamesViamao.getColumnModel().getColumn(4).setResizable(false);
            tblExamesViamao.getColumnModel().getColumn(4).setPreferredWidth(200);
        }

        txtBuscaViamao.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtBuscaViamaoActionPerformed(evt);
            }
        });
        ...
        javax.swing.GroupLayout GuiaViamaoConvenioLayout = new javax.swing.GroupLayout(GuiaViamaoConvenio);
        GuiaViamaoConvenio.setLayout(GuiaViamaoConvenioLayout);
        GuiaViamaoConvenioLayout.setHorizontalGroup(
            GuiaViamaoConvenioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, GuiaViamaoConvenioLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(GuiaViamaoConvenioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jPanel2, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jPanel1, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        GuiaViamaoConvenioLayout.setVerticalGroup(
            GuiaViamaoConvenioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(GuiaViamaoConvenioLayout.createSequentialGroup()
                .addContainerGap()
        ...
        PainelPai.addTab("Viamão", GuiaViamaoConvenio);
        ...
        btnNovoPoa.setPreferredSize(new java.awt.Dimension(120, 23));
        ...
        cbCategoriaPoa.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Selecione...", "1", "2", "3", "4", "5" }));
        cbCategoriaPoa.setEnabled(false);
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(cbCategoriaPoa, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
                        .addGap(26, 26, 26)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(txtObservacaoP, javax.swing.GroupLayout.PREFERRED_SIZE, 245, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jLabel12)
                    .addComponent(cbCategoriaPoa, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel8)
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addGap(18, 18, 18)
                                .addComponent(btnNovoPoa, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap(14, Short.MAX_VALUE))
        );
        ...
        if (tblExamesPoa.getColumnModel().getColumnCount() > 0) {
            ...
            tblExamesPoa.getColumnModel().getColumn(1).setPreferredWidth(150);
            tblExamesPoa.getColumnModel().getColumn(2).setResizable(false);
            tblExamesPoa.getColumnModel().getColumn(2).setPreferredWidth(10);
            tblExamesPoa.getColumnModel().getColumn(3).setResizable(false);
            tblExamesPoa.getColumnModel().getColumn(3).setPreferredWidth(40);
            tblExamesPoa.getColumnModel().getColumn(4).setResizable(false);
            tblExamesPoa.getColumnModel().getColumn(4).setPreferredWidth(200);
        }
        ...
        javax.swing.GroupLayout GuiaPoaConvenioLayout = new javax.swing.GroupLayout(GuiaPoaConvenio);
        GuiaPoaConvenio.setLayout(GuiaPoaConvenioLayout);
        GuiaPoaConvenioLayout.setHorizontalGroup(
            GuiaPoaConvenioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, GuiaPoaConvenioLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(GuiaPoaConvenioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jPanel4, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addComponent(jPanel3, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        GuiaPoaConvenioLayout.setVerticalGroup(
            GuiaPoaConvenioLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(GuiaPoaConvenioLayout.createSequentialGroup()
                .addContainerGap()
        ...
        PainelPai.addTab("Porto Alegre", GuiaPoaConvenio);
    ...
    private void btnAdicionarViamaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAdicionarViamaoActionPerformed
        ...
        String tabelaDestino = "viamaoipe";
    ...
    private void tblExamesViamaoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblExamesViamaoMousePressed
        ...
        cbCategoriaViamao.setSelectedItem(exameB.getCategoria());
    ...
    private void tblExamesPoaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblExamesPoaMousePressed
        ...
        cbCategoriaPoa.setSelectedItem(exameB.getCategoria());
    ...
    private void txtBuscaViamaoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtBuscaViamaoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtBuscaViamaoActionPerformed


    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JPanel GuiaPoaConvenio;
    private javax.swing.JPanel GuiaViamaoConvenio;
    ...
    private javax.swing.JComboBox<String> cbCategoriaPoa;
    private javax.swing.JComboBox<String> cbCategoriaViamao;
