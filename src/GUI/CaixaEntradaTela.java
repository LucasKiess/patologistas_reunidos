 ...
 * @author lucas
 */
public class CaixaEntradaTela extends javax.swing.JInternalFrame {
    ...
    final void apresentarRegistros(){
        Modelo.setNumRows(0);
        caixaC.controlePesquisaEntrada(Modelo);
    }
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Entrada de Receita - Caixa");
        ...
        txtDataInicio.setRequestFocusEnabled(false);
    ...
    private void btnBuscaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscaActionPerformed
        ...
        if((txtDataInicio.getDate() == null)||(txtDataFim.getDate() == null)){
            ...
            Modelo.setNumRows(0);
            caixaC.controlePesquisaEntreDataCaixaEntrada(Modelo, dataInicioSQL, dataFimSQL);
            somarTotal();
        }
    ...
    private void btnRegistraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistraActionPerformed
        ...
        if(txtData.getDate() == null){
            ...
            popularBeans();
            boolean confirma = caixaC.verificaDadosCaixaEntrada(caixaB);
            if(confirma == true){
                limpaCampos();
                apresentarRegistros();
                somarTotal();
    ...
    private void tblCaixaMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCaixaMousePressed
        ...
        caixaB = caixaC.controlePreencherCamposEntrada(Integer.parseInt(Modelo.getValueAt(tblCaixa.getSelectedRow(), 0).toString()));
    ...
    private void btnEditaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditaActionPerformed
        // TODO add your handling code here:
        popularBeans();
        boolean confirma = caixaC.verificaDadosEditarCaixaEntrada(caixaB);
        if(confirma == true){
            limpaCampos();
            apresentarRegistros();
            somarTotal();
    ...
    private void btnDeletaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeletaActionPerformed
        // TODO add your handling code here:
        popularBeans();
        caixaC.controleExcluiCaixaEntrada(caixaB);
        limpaCampos();
        apresentarRegistros();
        somarTotal();
        btnRegistra.setEnabled(true);
